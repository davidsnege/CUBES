...
En un primer momento no esperamos utilizar modelos de Crowdfunding o otros modelos de arrecadación de recursos por el simples hecho de que planteamos en realidad que este proyecto sea profesional y cuente con inversores en modo startup o inversiones de capital para la formación de una empresa (CUBE) especializada en la creación de nanosatelites y en un futuro desarollo de cohetes de pequeño tamaño para la inserción en baja orbita de hasta 200km de satelites tamaño 1U.
